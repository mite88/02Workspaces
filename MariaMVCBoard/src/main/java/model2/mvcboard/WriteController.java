...
public class WriteController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		//서버의 물리적 경로 얻어오기 req.getServletContext()를 통해 application
		//내장객체를 얻어온다.
		...
		if(mr == null) {
			JSFunction.alertLocation(resp, "제한용량초과 or 디렉토리 경로를 확인하세요.", "../mvcboard/write.do");
			return;
		}
		...
		dto.setPass(mr.getParameter("content"));
		dto.setContent(mr.getParameter("pass"));
