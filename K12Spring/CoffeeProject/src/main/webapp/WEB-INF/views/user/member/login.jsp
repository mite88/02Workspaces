...
/* 원숭이 로그인페이지 일단 넣어는 놨습니다  JS 부분을 넣어야합니다 */
 * 
 */
/* colors */
$darkBlue: #217093;
...
form {
    ...
    .inputGroup1 {
        ...
        .helper1 {
            top: 0;
            left: 0;
            transform: translate(1.4em, 1.8em) scale(1);
...
<!-- 카카오로그인 아이콘?? 크키조정  img에다가 넣어뒀습니다 -->
<style type="text/css">

.small1 {  width: 50px; height: 30px;}
...
<body>
	...
	<div class="inputGroup inputGroup3">
		...
		<button type="button" class="btm_image" id="img_btn"><img class="small1 "  src="<%=request.getContextPath()%>/resources/img/카카오로그인.png"></button>
	</div>	
</form>
