...
/**
 * <pre>
 * 1. 프로젝트명 : /storeowner/member/view.jsp
								...
								<div class="card-body">
									...
									<div class="mb-3 row">
										<div class="col-md-12">
											<div
												...
												<img
													src="<%=request.getContextPath()%>/resources/storeowner/assets/img/avatars/1.png"
									...
									<div class="mb-3 row">
										...
										<div class="col-md-6">
											...
											<div class="mb-3 row">
												<label for="html5-text-input"
													class="col-md-2 col-form-label">포인트</label>
												<div class="col-md-10">
												...
												<div class="mb-3 row">
												<label for="html5-text-input"
													class="col-md-2 col-form-label">성별</label>
												<div class="col-md-10">
													<input class="form-control" type="text" value=""
														id="html5-text-input" readonly>
												</div>
				                      ...
				                      -->
											...
											<div class="mb-3 row">
												<label for="html5-text-input"
													class="col-md-2 col-form-label">보유구독권</label>
												<div class="col-md-10">
													<input class="form-control" type="text" value=""
														id="html5-text-input" readonly>
												</div>
