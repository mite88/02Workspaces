...
public class homeController {
	...
	public String home() {
		String clientId = "Kai3v2jX6XReVcr9kS_B"; // 애플리케이션 클라이언트 아이디값"
		String clientSecret = "frGPqLysK1"; // 애플리케이션 클라이언트 시크릿값"

		String text = null;
		try {
			text = URLEncoder.encode("강남 파스쿠찌", "UTF-8");
		} catch (UnsupportedEncodingException e) {
			throw new RuntimeException("검색어 인코딩 실패", e);
		}

		String apiURL = "https://openapi.naver.com/v1/search/webkr?query=" + text; // json 결과
		// String apiURL = "https://openapi.naver.com/v1/search/webkr.xml?query="+ text;
		// // xml 결과
