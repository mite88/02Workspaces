...
<body>
	...
	<!-- 슬라이드 -->
	<div class="section-4">
		<jsp:include page="use/home/homeslide.jsp"></jsp:include>
	</div>
	...
	<script src="resources/js_jsp/homeindex.js?ver=1"></script>
	<!-- datepicker -->
	<script
		src="resources/admin/plugins/datepicker/bootstrap-datepicker.js"></script>
</body>
</html>