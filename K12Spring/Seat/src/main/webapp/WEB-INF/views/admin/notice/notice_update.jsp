												...
												<div class="form-group row mb-4" style="margin-bottom: 5px">
													<div class="col-sm-5">
														<input type="text" name="nb_title" class="form-control"
															placeholder="제목" id="nb_title" value="${nbVO.nb_title}" />
													</div>
													<div class="col-sm-4">
														...
														<script>
														if(${nbVO.nb_category=="공지사항"}){
															$("#selectBox").val("1").prop("selected", true);
														}else if(${nbVO.nb_category=="이벤트"}){
															$("#selectBox").val("2").prop("selected", true);
														}else if(${nbVO.nb_category=="기타"}){
															$("#selectBox").val("3").prop("selected", true);
														}
														...
														<input type="hidden" name="nb_category" id="nb_category"
															value="${nbVO.nb_category}">
													</div>
												</div>

												<div style="margin-bottom: 5px">
													<textarea id="nb_content" name="nb_content">${nbVO.nb_content}</textarea>
												</div>


												<button type="submit"
													class="btn btn-outline-success update_submit">수정</button>
